        ...
        <div className="grid max-w-screen-xl px-4 md:px-8 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              When you accept our TERMS AND CONDITIONS it means that we will keep your information
              and data safe and secure. Please do not give access to your account to anyone else.
            </p>
